            ...
            <ol className="list-decimal pl-10 pt-4">
              {courseData.data.map(subtopic => (
                <div className="p-4">
                  ...
                  <div className="p-8">
                    <a href={subtopic.githubLink} target="_blank">
                      <button className="p-4 bg-primary text-white rounded-full text-md flex items-center justify-center hover:bg-primary-orange">
                        <svg
